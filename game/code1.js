...
gdjs.TutorialCode.asyncCallback11013164 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.TutorialCode.asyncCallback11013164(runtimeScene, asyncObjectsList)));
}
}
...
{
{gdjs.TutorialCode.conditionTrue_1 = gdjs.TutorialCode.condition0IsTrue_0;
gdjs.TutorialCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11272908);
}
}if (gdjs.TutorialCode.condition0IsTrue_0.val) {
